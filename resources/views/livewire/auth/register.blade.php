                        ...
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="name" id="email" type="text" class="form-control" placeholder="Nome Completo" autofocus required>
                                    </div>
                                ...
                                <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="username" id="email" type="text" class="form-control" placeholder="Nome de usuario" required>
                                    </div>
                                ...
                                <div class="form-group mt-4 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="email" id="email" type="email" class="form-control" placeholder="email@email.com"  required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input wire:model.lazy="password" type="password" placeholder="Senha..." class="form-control" id="password" required>
                                        </div>
                                        @error('password') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                                    </div>
                                    <!-- End of Form -->
                                    <div class="form-check mb-4">
                                        <input class="form-check-input" type="checkbox" value="" id="terms" wire:change="activeOrNotBtnCadastrar()" required>
                                ...
                                <div class="d-grid">
                                    <button type="submit" @if(!$checkboxMarcado) disabled @endif class="btn btn-gray-800">Registrar</button>
                                </div>
                            </form>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Já Possui Conta?
                                    <a href="{{ route('login') }}" class="fw-bold">Entre aqui</a>
                                </span>
                            </div>
                        </div>
                    </div>
