                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-3 h3">Seja Bem Vindo</h1>
                        </div>
                        <form wire:submit.prevent="login" action="#" class="mt-4" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('forgot-password') }}" class="small text-right">Esqueceu a Senha?</a></div>
                                </div>
                            </div>
                            <div class="d-grid">
                        ...
                        <div class="mt-3 mb-4 text-center">
                            <span class="fw-normal">Ou faça login com</span>
                        </div>
                        <div class="d-flex justify-content-center my-4">
                            <a href="/auth/redirect" class="btn btn-icon-only btn-pill btn-outline-gray-500"
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <span class="fw-normal">
                                Não Tem Conta?
                                <a href="{{ route('register') }}" class="fw-bold">Crie Aqui</a>
                            </span>
                        </div>
                    </div>
                </div>
